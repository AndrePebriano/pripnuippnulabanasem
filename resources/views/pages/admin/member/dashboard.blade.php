            ...
            <div class="card m-lg-0">
                <div class="card-body">
                    ...
                    <ul class="list-style5">
                        ...
                        <li>Periode Kepengurusan (List Semua Periode Kepengurusan Pelajar NU Labanasem)</li>
                    ...
                    <ul class="list-style5">
                        <li>List Semua Anggota Pelajar NU Labanasem. [selesai] <a href="{{ route('anggota') }}">Kunjungi</a>
                        </li>
                    </ul>
                    ...
                    <ul class="list-style5">
                        <li>Halaman Untuk menghubungi admin Pelajar NU Labanasem lewat website</li>
                    </ul>
                </div>
            </div>
        </div>
