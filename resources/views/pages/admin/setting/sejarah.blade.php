                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <input type="text" id="sub_judul" name="sub_judul" class="form-control"
                                placeholder="Sejarah berdirinya PR IPNU IPPNU Labanasem"
...
@section('stylesheet')
<script src="https://cdn.tiny.cloud/1/j2d5tq2icv1wikkonofi6nscvzd885ygwragb3gg04o0m52z/tinymce/7/tinymce.min.js" referrerpolicy="origin"></script>
@endsection
