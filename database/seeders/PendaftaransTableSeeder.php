    ...
    public function run()
    {
        ...
        \DB::table('pendaftarans')->insert(array(
            ...
            array(
                ...
                'pengumuman' => 'Sensus anggota sedang dilakukan, untuk semua anggota Pelajar NU Labanasem yang belum tercatat pada Aplikasi Sistem Informasi Anggota. diharapkan untuk mengisi sensus disini(link)',
                'no_urut' => '1',
                'dari' => '2022-05-01',
                'sampai' => '2022-06-01',
